...
var $author$project$Main$edgeLabelToString = $elm$core$Basics$always(
	$elm$core$Maybe$Just(''));
...
var $author$project$Main$nodeLabelToString = A2($elm$core$Basics$composeL, $elm$core$Maybe$Just, $elm$core$String$fromInt);
...
var $author$project$Main$init = function (_v0) {
	var nodes = A2($elm$core$List$repeat, 9, 0);
	...
	var circuit = A2($elm_community$graph$Graph$fromNodeLabelsAndEdgePairs, nodes, edges);
	return _Utils_Tuple2(
		{circuit: circuit},
		$author$project$Main$showCircuit(
			A3($elm_community$graph$Graph$DOT$output, $author$project$Main$nodeLabelToString, $author$project$Main$edgeLabelToString, circuit)));
};
...
var $elm_community$graph$Graph$toString = F3(
	function (nodeToString, edgeToString, graph) {
		return 'Graph [' + (A2(
			$elm$core$String$join,
			', ',
			A2(
				...
				function (_v0) {
					var id = _v0.id;
					var label = _v0.label;
					return 'Node ' + ($elm$core$String$fromInt(id) + function () {
						var _v1 = nodeToString(label);
						if (_v1.$ === 'Nothing') {
							return '';
						} else {
							var text = _v1.a;
				...
				$elm_community$graph$Graph$nodes(graph))) + ('] [' + (A2(
			$elm$core$String$join,
			', ',
			A2(
				$elm$core$List$map,
				function (_v2) {
					...
					var to = _v2.to;
					var label = _v2.label;
					return 'Edge ' + ($elm$core$String$fromInt(from) + ('->' + ($elm$core$String$fromInt(to) + function () {
						var _v3 = edgeToString(label);
						if (_v3.$ === 'Nothing') {
							return '';
						} else {
							var text = _v3.a;
...
var $author$project$Main$view = function (model) {
	return $elm$html$Html$text(
		A3($elm_community$graph$Graph$toString, $author$project$Main$nodeLabelToString, $author$project$Main$edgeLabelToString, model.circuit));
};
